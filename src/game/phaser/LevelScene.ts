...
export class LevelScene extends Phaser.Scene {
  ...
  // --- Atmosphere (lighting/particles/post-FX), see AtmosphereFX.ts -------
  private atmosphere?: AtmosphereFX;
  ...
  create() {
    ...
    if (q !== "low") {
      ...
      if (q === "high" || q === "ultra") {
        ...
        this.atmosphere.setupAmbientParticles();
        this.atmosphere.setupForegroundLeaves();
      }
    }
  ...
  update(time: number, deltaMs: number) {
    ...
    this.atmosphere?.updateCatLight(this.cat.x, this.cat.y);
